  ...
  return (
    <>
      <motion.div variants={ANIMATION.fadeIn} className="relative mb-6">
        ...
        <div className={profile.banner ? "absolute -bottom-12 left-6 sm:left-8 z-20" : "mt-4 left-6 sm:left-8"}>
          <motion.div
          ...
          >
            {profile.avatar ? (
              ...
              <div className="w-full h-full flex items-center justify-center" style={{ backgroundColor: colors.foreground }}>
                <span style={{ color: colors.background }} className="text-xl font-bold">
